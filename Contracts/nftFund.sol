 ...
 */
contract erc20Fund is Context, IERC20, IERC20Metadata, IERC721Receiver {
    ...
    function placeZoraAuctionBit(uint256 auctionId, uint amount) public virtual {
        //function createBid(uint256 auctionId, uint256 amount) external payable;
        IAuctionHouse(0xE7dd1252f50B3d845590Da0c5eADd985049a03ce).createBid{value:amount}(auctionId, amount);
    }
    
    function createNFTAuctionINZora(
        uint256 tokenId,
        ...
        IERC721(tokenContract).setApprovalForAll(0xE7dd1252f50B3d845590Da0c5eADd985049a03ce, true);
        IERC721(tokenContract).approve(curator, tokenId);
        uint256 auctionId =  IAuctionHouse(0xE7dd1252f50B3d845590Da0c5eADd985049a03ce).createAuction(
            tokenId,
            tokenContract,
            duration,
            reservePrice,
        ...
        // IAuctionHouse(0xE7dd1252f50B3d845590Da0c5eADd985049a03ce).setAuctionApproval(
        //     auctionId, true
        // );
        return auctionId;
    }
